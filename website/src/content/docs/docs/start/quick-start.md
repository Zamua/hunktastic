...
Keep Hunk open, then in another terminal ask your coding agent to run `hunkt skill path` and use the returned review skill. Continue with [Review with an agent](/docs/agents/review-with-an-agent/).
