 ...
 */
export function buildEditList(hunks: Hunk[]): DiffEdit[] {
  ...
  for (const hunk of hunks) {
    ...
    for (const content of hunk.hunkContent) {
      ...
      edits.push({
        oldStart: oldLine,
        oldEnd: oldLine + content.deletions,
        newStart: newLine,
        newEnd: newLine + content.additions,
      });
 ...
 */
export function resolveNotes(notes: StoredNote[], files: NoteResolutionFile[]): ResolvedNote[] {
