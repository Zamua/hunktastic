...
export function buildAppMenus({
  ...
  const specs: Record<Exclude<MenuId, "extensions">, MenuEntrySpec[]> = {
    ...
    navigate: [
      ...
      SEPARATOR,
      { commandId: "hunk.review.scrollLineUp", label: "Scroll up one line" },
      { commandId: "hunk.review.scrollLineDown", label: "Scroll down one line" },
      { commandId: "hunk.review.halfPageUp", label: "Half page up" },
      { commandId: "hunk.review.halfPageDown", label: "Half page down" },
      { commandId: "hunk.review.pageUp", label: "Page up" },
      { commandId: "hunk.review.pageDown", label: "Page down" },
      SEPARATOR,
      { commandId: "hunk.review.jumpToTop", label: "Jump to start" },
      { commandId: "hunk.review.jumpToBottom", label: "Jump to end" },
      SEPARATOR,
      { commandId: "hunk.review.focusFilter", label: "Focus filter" },
    ],
    agent: [
